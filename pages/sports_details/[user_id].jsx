...
const Sports_details = () => {
    ...
    useEffect(() => {
        ...
        if (router?.query?.user_id && router?.query?.user_id !== '') {
            dispatch(getCategoryAction({ type: 'Sports', userID: router?.query?.user_id }));
        }
    }, [router?.query]);
                ...
                <div className="max-w-[1024px] mx-auto px-4 my-20">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2">
                        <div className='flex justify-center md:justify-end'>
                            <img src={category?.image} alt="" className='w-full max-w-[370px] object-cover' />
                        </div>
                                ...
                                <div className='grid grid-cols-2 gap-12'>
                                    {category?.details?.children && category?.details?.children !== '' &&
                                        <div className="grid grid-cols-2 mb-3">
                                            ...
                                            <img src={category?.details?.children} alt="" />
                                        </div>
                                    }
                                </div>
                            </div>
