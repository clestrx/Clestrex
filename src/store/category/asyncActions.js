import { addCategoryError, addCategoryLoading, addCategorySuccess, getAllCategoryError, getAllCategoryLoading, getAllCategorySuccess, getCategoryError, getCategoryLoading, getCategorySuccess } from './actions';
import api from '../api';
...
const addCategoryAction = (postData) => {
  return async (dispatch) => {
    try {
      ...
      const response = await api.post('api/category-add', postData, { includeAuthorization: false });
...
const getAllCategoryAction = (postData) => {
  return async (dispatch) => {
    try {
      ...
      // Perform the asynchronous operation (e.g., API call)
      const response = await api.post('api/category-get-all', postData, { includeAuthorization: false });
      const data = response.data;
...
const getCategoryAction = (postData) => {
  return async (dispatch) => {
    try {
      ...
      // Perform the asynchronous operation (e.g., API call)
      const response = await api.post('api/category-get', postData, { includeAuthorization: false });
      const data = response.data;
